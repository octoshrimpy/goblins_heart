...
# If the texture should be randomly flipped on the X axis
#export (bool) var randomize_flip: bool = false setget _set_randomize_flip
...
#func _set_randomize_flip(b: bool):
#	randomize_flip = b
#	emit_signal("changed")
